...
export default function ResidentForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await sendPasswordResetEmail(auth, email.trim().toLowerCase(), {
        url: window.location.origin + '/resident-login',
      ...
      switch (err.code) {
        case "auth/user-not-found":
          errorMessage = "No resident account found with this email address. Please check your email or contact your secretary.";
          break;
